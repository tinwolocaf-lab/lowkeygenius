...
- [-] 1. Set up database schema and types
  - [ ] 1.1 Add audio_generation_jobs table migration if not exists
    - Create migration file for audio_generation_jobs table
    - Add indexes for course_id and user_id
    - _Requirements: 6.1, 6.5_
  - [ ] 1.2 Update database types to include audio_generation_jobs
...
- [ ] 2. Implement audio access control utilities
  - [ ] 2.1 Create checkAudioAccess utility function
...
- [ ] 3. Implement text processing utilities
  - [ ] 3.1 Create stripMarkdown utility function
  ...
  - [ ] 3.3 Create splitTextIntoChunks utility function
...
- [ ] 5. Create VoiceSelector component
  - [ ] 5.1 Implement VoiceSelector component
...
- [ ] 6. Create GenerateAudio page
  - [ ] 6.1 Create GenerateAudio page component
...
- [ ] 7. Add routing and navigation
  - [ ] 7.1 Add GenerateAudio route to router
    - Add route /courses/:courseId/generate-audio
    - Protect route with authentication
    - _Requirements: 1.1_
  - [ ] 7.2 Add navigation button to course detail page
...
- [ ] 9. Enhance CourseAudioPlayer component
  - [ ] 9.1 Verify existing audio player functionality
...
- [ ] 10. Implement audio file storage path utility
  - [ ] 10.1 Create getAudioStoragePath utility function
...
- [ ] 11. Update edge functions if needed
  - [ ] 11.1 Review and verify generate-audio edge function
  ...
  - [ ] 11.2 Review and verify generate-course-audio edge function
...
- [ ] 12. Integrate audio add-on with PolarSH
  - [ ] 12.1 Add audio add-on product ID to environment
    - Add VITE_POLAR_PRODUCT_AUDIO_ADDON to .env
    - _Requirements: 5.1, 5.2_
  - [ ] 12.2 Verify pricing page audio add-on section
    - Confirm audio add-on displays with $10/month pricing
    - Confirm checkout initiates correctly
    - _Requirements: 5.1, 5.2_
  - [ ] 12.3 Update webhook handler for audio add-on subscription
...
- [ ] 13. Add audio button to CourseView
  - [ ] 13.1 Verify audio button in lesson view
    - Confirm "Listen to Audio Version" button appears when audio_url exists
    - Confirm clicking opens CourseAudioPlayer
    - _Requirements: 2.1_
  - [ ] 13.2 Verify audio icon in lesson sidebar
